...
class ApplicationView(View):
    ...
    def setup_treeview(self, ctrl):
        ...
        for name in list(set(TV_DICT.values())):
            ...
            col_usertype, col_group, col_username, col_usernumber, col_userid = range(5)
            ...
            if name in 'contacts_treeview':
                ...
                column = gtk.TreeViewColumn(_("Group"), cell,
                                            text=col_group)
                column.set_resizable(True)
                column.set_sort_column_id(col_group)
                cell.set_property('editable', True)
                cell.connect('edited', ctrl._group_contact_cell_edited)
                treeview.append_column(column)
