...
class ContactsListController(Controller):
    ...
    def _setup_view(self):
        ...
        col_type, col_group, col_name, col_number, col_pyobj = range(5)
        ...
        column = gtk.TreeViewColumn(_("Group"), cell, text=col_group)
    ...
    def _row_activated_handler(self, treeview, path, col):
        ...
        number = model.get_value(_iter, 3)
    ...
    def on_add_button_clicked(self, widget):
        ...
        numbers = []
        for _iter in iters:
            numbers.append(model.get_value(_iter, 3)) # 3 == number in model
