...
# credits
APP_AUTHORS = ['Rafael Treviño Menéndez <rtrevino@gmv.es>',
               'Pablo Martí Gamboa <pmarti@warp.es>',
               'Jaime Soriano Pastor <jsoriano@warp.es>']
APP_DOCUMENTERS = ['Rafael Treviño Menéndez <rtrevino@gmv.es>',
                   'Pablo Martí Gamboa <pmarti@warp.es>',
                   'Enrique Matias Sanchez <cronopios@gmail.com>',
                   'Jaime Soriano Pastor <jsoriano@warp.es>']
APP_ARTISTS = ['Rafael Treviño Menéndez <rtrevino@gmv.es>',
               'Pablo Martí Gamboa <pmarti@warp.es>',
               'Jaime Soriano Pastor <jsoriano@warp.es>',
