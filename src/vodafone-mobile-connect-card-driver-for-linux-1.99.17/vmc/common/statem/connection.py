...
from vmc.common.notifications import (SIG_NEW_CONN_MODE, NO_SIGNAL,
...
class ConnectStateMachine(StateMachineMixin, Modal):
    ...
    def connect(self):
        ...
        @raise vmc.common.exceptions.AlreadyConnecting: raised when the
        state machine is already connecting
        @raise vmc.common.exceptions.AlreadyConnected: raised when the
    ...
    def close(self, hotplug=False):
        ...
        @raise vmc.common.exceptions.NotConnectedError: raised when we are
        not connected
        """
