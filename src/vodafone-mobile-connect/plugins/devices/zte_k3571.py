...
class ZTEK3571(ZTEDBusDevicePlugin):
    """
    L{vmc.common.plugin.DBusDevicePlugin} for ZTE's version of Vodafone's K3571
    """
    ...
    __properties__ = {
        ...
        'usb_device.product_id': [0x1010],
    }

    # K3571-Z uses ttyUSB3(data) and ttyUSB1(status)
    hardcoded_ports = (3, 1)
