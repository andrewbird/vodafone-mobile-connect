...
Requires:	usb_modeswitch >= 0.9.7, wvdial, hal, lsb, python-serial, python-twisted, python-twisted-conch, python-notify, python-tz, python-gobject2, dbus-1-python, python-cairo, python-crypto, python-gtk >= 2.10.0, python-gnome
