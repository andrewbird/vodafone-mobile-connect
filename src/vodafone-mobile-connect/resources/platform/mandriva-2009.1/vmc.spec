...
Requires:	usb_modeswitch wvdial hal lsb python-serial python-twisted python-twisted-conch python-notify python-pytz python-gobject python-dbus python-cairo pycrypto pygtk2.0 >= 2.14.0
