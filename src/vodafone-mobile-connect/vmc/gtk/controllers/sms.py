...
from vmc.common.sms import (ShortMessageSubmit, MAX_LENGTH_7BIT,
                            MAX_LENGTH_UCS2)

from vmc.gtk import Controller, Model
from vmc.gtk.controllers.contacts import ContactsListController
from vmc.gtk.controllers.base import TV_DICT, TV_DICT_REV
from vmc.gtk.controllers.preferences import SMSPreferencesController
from vmc.gtk.models.preferences import PreferencesModel, transform_validity
from vmc.gtk.views.contacts import ContactsListView
from vmc.gtk.views.preferences import SMSPreferencesView
