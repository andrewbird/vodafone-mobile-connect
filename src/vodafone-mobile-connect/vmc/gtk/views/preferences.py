...
from vmc.common.dialers import AUTH_OPTS_DICT_REV
from vmc.common.dialers import get_profiles_list
from vmc.common.encoding import _
from vmc.gtk.models.preferences import SMSCListStoreModel
