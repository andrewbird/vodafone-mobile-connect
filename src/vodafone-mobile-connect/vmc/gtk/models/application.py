...
from vmc.common.notifications import THREEG_SIGNALS

from vmc.common.config import config
from vmc.common.persistent import usage_manager
from vmc.common.profiles import ProfileUpdater
...
class ApplicationModel(BaseWrapperModel):
    ...
    def __init__(self, wrapper=None):
        ...
        self.ctrl = None
        # reference to vmc.common.daemon.DaemonCollection
        self.daemons = None
        # reference to vmc.common.notification.NotificationsManager
