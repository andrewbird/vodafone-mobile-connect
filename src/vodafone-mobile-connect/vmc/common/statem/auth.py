...
class AuthStateMachine(StateMachineMixin, Modal):
    ...
    def start_auth(self):
        ...
        @raise vmc.common.exceptions.AuthCancelled: User cancelled the auth
        @raise vmc.common.exceptions.CMEErrorSIMFailure: SIM unknown error
        @raise vmc.common.exceptions.CMEErrorSIMNotInserted: SIM not inserted
        @raise vmc.common.exceptions.DeviceLocked: Device is locked
        """
        self.do_next()
