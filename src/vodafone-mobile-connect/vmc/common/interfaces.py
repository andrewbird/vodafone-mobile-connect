...
class ICollaboratorFactory(Interface):
    def get_collaborator(self, device, view):
        ...
        @type device: L{vmc.common.plugin.DevicePlugin}
...
class IVMCPlugin(Interface):
    ...
    def initialize():
        ...
        @raise vmc.common.exceptions.PluginDependenciesError: Raised when the
        necessary dependencies are missing
        @raise vmc.common.exceptions.PluginInitializationError:  Raised when
...
class INotificationPlugin(IVMCPlugin):
    ...
    def on_notification_received(wrapper, notification):
        ...
        @type wrapper: L{vmc.common.wrapper.BaseWrapper} subclass
        @type notification: vmc.common.notifications.Notification
