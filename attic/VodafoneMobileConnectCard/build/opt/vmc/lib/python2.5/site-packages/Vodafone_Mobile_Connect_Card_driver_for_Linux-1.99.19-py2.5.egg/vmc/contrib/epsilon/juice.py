...
# modified by Pablo Martí pmarti@warp.es on 19 Oct 2007
# as we're not using any OpenSSL stuff, I've moved the imports into the
# methods that were using those imports
...
class Juice(LineReceiver, JuiceParserBase):
    ...
    def startTLS(self, certificate, *verifyAuthorities):
        from vmc.contrib.epsilon.sslverify import (Certificate,
                                                   problemsFromTransport)
    ...
    def connectionLost(self, reason):
        ...
        if problems:
            ...
            from vmc.contrib.epsilon.sslverify import PeerVerifyError
